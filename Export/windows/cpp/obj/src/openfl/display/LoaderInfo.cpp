...
{
		HX_STACK_FRAME("openfl.display.LoaderInfo","this_onComplete",0x993d1516,"openfl.display.LoaderInfo.this_onComplete","openfl/display/LoaderInfo.hx",104,0x88528a51)
		HX_STACK_THIS(this)
...
::openfl::utils::ByteArray LoaderInfo_obj::get_bytes( ){
	HX_STACK_FRAME("openfl.display.LoaderInfo","get_bytes",0xce1f599f,"openfl.display.LoaderInfo.get_bytes","openfl/display/LoaderInfo.hx",118,0x88528a51)
	HX_STACK_THIS(this)
	HX_STACK_LINE(118)
	return this->data;
}
